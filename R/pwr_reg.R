...
#'
#' @param seeded numeric vector with number of cells seeded
#' @param counted numeric vector with number of colonies counted (same length
#'   as \code{seeded})
#'
#' @return \code{summary.lm} object as returned by \code{\link{summary}}
#'
#' @examples
#' pwr_reg(seeded = 10^(seq(1,5,0.5)),
